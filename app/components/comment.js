...
handleLikeClick(clickEvent) {
  ...
  if (clickEvent.button === 0) {
    ...
    if (this.didUserLike()) {
      ...
      unlikeCommentItem(this.state.commentId, this.state.index, 4, callbackFunction);
    } else {
      // User clicked 'like' button.
      likeCommentItem(this.state.commentId, this.state.index, 4, callbackFunction);
    }
  }
}
    ...
    return (
      <div>
        ...
        <div className="media-body">
          ...
          <br /> <a href="#" onClick={(e) => this.handleLikeClick(e)}> {this.state.likeCounter.length} {likeButtonText}</a> · <a href="#">Reply</a> ·
