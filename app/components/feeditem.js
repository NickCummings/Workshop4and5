        ...
        <div className="panel-footer">
          ...
          <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
            ...
            data.comments.map((comment, i) => {
              ...
              return (
                <Comment key={i} author={comment.author} postDate={comment.postDate} commentId={this.state._id} index={i} likeCounter={comment.likeCounter}>{comment.contents}</Comment>
              );
            })
            }
          </CommentThread>
